...
public class SavedSearchDef implements Serializable{
    ...
    private QueryLOV _query;
        ...
        private ConjunctionCriterion.Conjunction _defaultConjunction = ConjunctionCriterion.Conjunction.AND;
        ...
        // Mode
        private QueryDescriptor.QueryMode _uiHintMode = QueryDescriptor.QueryMode.ADVANCED;
        // Show In List
...
//        }
    ...
    public void setQuery(QueryLOV query) {
        this._query = query;
        for(SearchFieldDef sfd: getSearchFields()){
            sfd.setQuery(query);
        }
    }
