 ...
 */
    ...
    private QueryLOV _query;
        ...
        private ConjunctionCriterion.Conjunction _beforeConjunction = ConjunctionCriterion.Conjunction.AND;
        // default operator to use with this search field
        private OperatorDef _operator = OperatorDef.NO_OPERATOR;
        ...
        public AttributeDef getAttributeDef() {
            return getAttributeDescriptor(_attrName);
        }
    ...
    private AttributeDef getAttributeDescriptor(String attrName) {
        return getQuery().getAttributeDescriptor(attrName);
    }

    public void setQuery(QueryLOV _query) {
        this._query = _query;
    }

    public QueryLOV getQuery() {
        return _query;
    }
}
