...
public class JSFUtils {
    ...
    public static void addMessage(String componentId, String message, String detail, FacesMessage.Severity severity) {
        FacesContext ctx = getFacesContext();
        FacesMessage fm =
   ...
   */
    ...
    //added utility with specified resource bundle
    public static String getStringFromBundle(String baseName, String key, String defaultValue){
        return getStringFromSpecificBundle(baseName, key, defaultValue, getLocale(), getClassLoader());
    }
    
    public static String getStringFromSpecificBundle(String baseName, String key, String defaultValue,
                                   Locale locale, ClassLoader loader) {
        ResourceBundle bundle = ResourceBundle.getBundle(baseName, locale, loader);
        return getStringSafely(bundle, key, defaultValue);
    }
